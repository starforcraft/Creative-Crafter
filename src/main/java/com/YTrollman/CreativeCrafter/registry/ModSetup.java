...
public class ModSetup {
    ...
    public static void init(final FMLCommonSetupEvent event) {
        ...
        ModBlockEntities.CREATIVE_CRAFTER_TILE_ENTITY.get().create(BlockPos.ZERO, null).getDataManager().getParameters().forEach(BlockEntitySynchronizationManager::registerParameter);
    }
